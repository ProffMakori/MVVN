...
import com.example.firebasestorage.ui.theme.screens.dashboad.DashboadScreen
...
import com.example.firebasestorage.ui.theme.screens.services.ServiceScreen
...
fun AppNavHost(modifier: Modifier = Modifier, navController:NavHostController = rememberNavController(), startDestination:String = ROUT_SPLASH) {
    NavHost(navController = navController, modifier=modifier, startDestination = startDestination){
        ...
        composable(ROUT_DASHBOAD){
            DashboadScreen(navController)
        }
